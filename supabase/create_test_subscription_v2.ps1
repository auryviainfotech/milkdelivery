...
Write-Host "Re-trying Test Subscription with Valid Product ID..." -ForegroundColor Cyan

# 1. Update Profile (Just in case)
Invoke-SQL "
...
# 2. Check if subscription already exists, delete if so
...
VALUES 
('$uuid', '$validProductId', 'daily', 2, '$today', '$nextMonth', '07:00 AM - 08:00 AM', 3000, 'active');
"

Write-Host "Done! Refresh 'Subscriptions' should work now." -ForegroundColor Green
